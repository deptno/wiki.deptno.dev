    ...
    <div className="p-2">
      <ChildrenWithSearchResult>
        <div className="flex justify-end gap-2 border-b-2">
          <a className="underline border-l-blue-400" href={`${URL_WIKI}/edit/${branch}/${wikiBasedPath}.md`} target="_blank">수정</a>
          <a className="underline border-l-blue-800" href={`${URL_WIKI}/commits/${branch}/${wikiBasedPath}.md`} target="_blank">기록</a>
          <a className="underline border-l-blue-800" href={`${URL_WIKI}/blame/${branch}/${wikiBasedPath}.md`} target="_blank">추적</a>
        </div>
